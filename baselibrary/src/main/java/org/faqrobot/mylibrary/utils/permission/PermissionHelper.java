package org.faqrobot.mylibrary.utils.permission;
...
public class PermissionHelper {
    ...
    public final static int CALL_PHONE_CODE = 107;
    ...
    public static final PermissionModel PERMISSION_READ_CONTACTS = new PermissionModel(
            ...
            "我们需要访问通讯录的权限",
            READ_CONTACTS_CODE);
    public static final PermissionModel PERMISSION_CALL_PHONE = new PermissionModel(
            "电话",
    ...
    public void applyPermissions() {
        try {
            for (final PermissionModel model : mPermissionModels) {
                if (PackageManager.PERMISSION_GRANTED != ContextCompat.checkSelfPermission(mActivity, model
                        .permission)) {
    ...
    private boolean openApplicationSettings(int requestCode) {
        try {
            Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.parse("package:" + mActivity
                    .getPackageName()));
